...
const chessPuzzles = [
  ...
  { id: "novice-8", difficulty: "novice", name: { en: "Queen Descent", ja: "クイーンの降下" }, fen: "8/1p6/3Q4/8/8/3p1K2/8/4k3 w - - 0 1", line: ["d6d3", "b7b6", "d3e2"] },
  { id: "novice-9", difficulty: "novice", name: { en: "Knight Blockade", ja: "ナイトの封鎖" }, fen: "8/8/1n6/8/1N6/2R2K2/8/7k w - - 0 1", line: ["f3g3", "b6c8", "c3c1"] },
  ...
  { id: "intermediate-6", difficulty: "intermediate", name: { en: "Pinned Mate", ja: "ピンのメイト" }, prompt: { en: "Force the bishop to block the check, capture it, and use the queen to seal the b-file escape.", ja: "ビショップにチェックをブロックさせて取り、クイーンでbファイルへの逃げ道を封じよう。" }, fen: "k7/5Q1p/8/qb2PB2/5p1B/p6R/8/7K w - - 0 1", line: ["f5e4", "b5c6", "e4c6", "a8b8", "f7b7"] },
  ...
  { id: "advanced-4", difficulty: "advanced", name: { en: "Bishop interference", ja: "ビショップの干渉" }, fen: "8/8/2r5/2B5/6K1/6Q1/8/k7 w - - 0 1", line: ["g3c3", "a1a2", "c3c2", "a2a1", "c5d4", "c6c3", "d4c3"] },
  ...
  { id: "advanced-6", difficulty: "advanced", name: { en: "Smothering King", ja: "キングを窒息させろ" }, prompt: { en: "Capture with check, force the king down the h-file, and let the bishop close the final escape square.", ja: "チェックで取り、キングをhファイルへ追い、ビショップで最後の逃げ道を閉じよう。" }, fen: "2N2q1k/1Pr1P3/4p3/3PP3/4r3/8/5Qp1/K3B3 w - - 0 1", line: ["f2f8", "h8h7", "f8f7", "h7h6", "e1d2", "e4e3", "d2e3"] },
  { id: "advanced-7", difficulty: "advanced", name: { en: "Two Knights and a Bishop", ja: "2頭のナイトとビショップ" }, prompt: { en: "Promote with check, use the bishop to pull the king forward, and let the knight close the final square.", ja: "チェック付きで昇格し、ビショップでキングを前へ引き出し、ナイトで最後のマスを閉じよう。" }, fen: "7k/2p1P2P/2pp4/3P1qpp/6R1/2NB1P2/3p2pP/1K6 w - - 0 1", line: ["e7e8q", "h8h7", "d3f5", "h7g7", "g4g5", "g7f6", "c3e4"] },
  { id: "advanced-8", difficulty: "advanced", name: { en: "Fair Trade...?", ja: "公平な交換…？" }, prompt: { en: "Promote with check, keep the queen active, and use the rook sacrifice on a8 to force the final capture.", ja: "チェック付きで昇格し、クイーンを働かせ、a8のルーク犠牲で最後の取りを強制しよう。" }, fen: "3R4/kP6/7p/N4p1Q/1n6/2r2P2/4pP2/K5R1 w - - 0 1", line: ["b7b8q", "a7a6", "b8b7", "a6a5", "d8a8", "b4a6", "a8a6"] },
  { id: "advanced-9", difficulty: "advanced", name: { en: "Remove the Defender", ja: "守備駒を排除せよ" }, prompt: { en: "Remove each blocking defender with check, then place the bishop where it seals the last flight square.", ja: "ブロックする守備駒をチェックで順番に排除し、最後の逃げ道をビショップで封じよう。" }, fen: "B1rn4/k1P2PQ1/P2P4/6P1/8/4p3/2B3p1/2K2N2 w - - 0 1", line: ["g7d4", "a7a6", "c2d3", "a6a5", "d4c5", "a5a4", "d3c2"] },
  { id: "advanced-10", difficulty: "advanced", name: { en: "Anastasia's Power", ja: "アナスタシアの力" }, prompt: { en: "Sweep the seventh rank, use the knight check to force the king toward e8, and finish with the rook.", ja: "7段目を掃除し、ナイトチェックでキングをe8へ追い、ルークで仕上げよう。" }, fen: "3q1k2/5pp1/3PPR2/2p3N1/3B3p/3p2P1/8/1K4n1 w - - 0 1", line: ["f6f7", "f8g8", "f7g7", "g8f8", "g5h7", "f8e8", "g7g8"] },
